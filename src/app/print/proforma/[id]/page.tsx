        ...
        <div style={{ padding: '12mm 14mm 42mm 14mm', flex: 1, position: 'relative' }}>
          ...
          <div style={{ marginBottom: '7mm', fontSize: '13px' }}>
            <div style={{ marginBottom: '4px' }}>
              ...
              <span style={{ fontWeight: 'bold', marginLeft: '10px', fontSize: '14px' }}>{client?.name || proforma?.recipient_name || '—'}</span>
            </div>
            <div>
          ...
          {proforma.notes && (
            <div style={{ marginBottom: '5mm', fontSize: '11px' }}>
              <div style={{ fontStyle: 'italic', fontSize: '10px', color: '#555', marginBottom: '3px' }}>Notes :</div>
              <div style={{ whiteSpace: 'pre-line' }}>{proforma.notes}</div>
            </div>
          )}
